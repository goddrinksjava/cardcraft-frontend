    ...
    <div class="bg-white dark:bg-gray-900 flex justify-center min-h-screen">
        ...
        <div class="flex items-center px-8 lg:px-0 w-full lg:w-1/2">
            ...
            <div class="flex-1">
                ...
                <form action="/admin/characters/{{ $character->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex flex-row justify-between flex-wrap items-center">
                        ...
                        <div class="relative w-[200px] h-[200px]">
                            ...
                            <div class="w-full h-full bg-gray-50 bg-cover border bg-no-repeat bg-center"
                                id="imagePreview"
                                style="background-image: url(../../../storage/characters/{{ $character->id }});">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-6">
                            ...
                            <select
                                ...
                                id="anime" name="anime">
                                <option value="{{ $character->anime->id }}">
