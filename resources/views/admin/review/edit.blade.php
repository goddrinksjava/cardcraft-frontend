    ...
    <div class="bg-white dark:bg-gray-900 flex justify-center min-h-screen">
        ...
        <div class="flex items-center px-8 lg:px-0 w-full lg:w-1/2">
            ...
            <div class="flex-1">
                ...
                <form action="/admin/reviews/{{ $review->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-8">
                        ...
                        <x-numeric-input name=" score" label="Score" value="{{ $review->score }}" min="1" max="10"
                            step="1" />
