            ...
            <div class="flex-1">
                ...
                <form action="/admin/users" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="relative w-32 h-32">
                            ...
                            <div class="w-full h-full relative rounded-full border-4 shadow-sm">
                                <div class="w-full h-full rounded-full bg-gray-200 bg-cover bg-no-repeat bg-center"
                                    id="imagePreview" style="background-image: url(../../storage/default-avatar.png);">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8">
                        ...
                        <x-text-input name="email" type="email" placeholder="example@example.com"
                            label="Email Address" />
                        ...
                        <div class="mt-6">
                            <x-checkbox name="verifiedEmail" label="Verified Email" />
                        </div>
                        ...
                        <fieldset class="mt-6">
                            ...
                            @foreach ($roles as $role)
                                <div>
                                    <x-checkbox name="roles[{{ $role }}]" :label="$role"
